...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(293, 130);
			...
			this->label2->Location = System::Drawing::Point(425, 130);
			...
			this->label3->Location = System::Drawing::Point(101, 340);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(732, 69);
			this->label3->TabIndex = 2;
			this->label3->Text = L"PLAYER O IS WINNER !!";
			// 
			// MyForm2
			// 
			...
			this->ClientSize = System::Drawing::Size(889, 553);
